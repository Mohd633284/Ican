...
const loadInvoices = async () => {
  ...
  try {
    ...
    try {
      ...
      if (result.success) {
        invoices.value = result.invoices || result.data || []
      } else {
...
const createNewInvoice = () => {
  ...
  router.push({ name: 'ican-app-invoice-quickfill', query: { branch: currentBranch.value } })
}
...
const editInvoice = (invoice) => {
  ...
  router.push({ name: 'ican-app-invoice-preview', query: { branch: currentBranch.value } })
}
